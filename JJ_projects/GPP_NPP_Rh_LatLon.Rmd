...
Calculate the annual mean, in theory the dimensions should not change because this is annual data. This is a precautionary step  just incase the results for a single year were split over mulitple files. 
```{r}
raw_data %>%  
...
write.csv(x = df_area_coords, file = file.path(out_dir, paste0('area_latlon_model', yrs, '.csv')), row.names = FALSE)
```
